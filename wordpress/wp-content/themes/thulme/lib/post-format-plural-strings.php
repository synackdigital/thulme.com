...
add_filter( 'single_term_title', 'post_format_single_term_title' );
 ...
 * @return string
 */
function post_format_single_term_title( $title ) {

  if ( is_tax( 'post_format' ) ) {
    $term = get_queried_object();
    $plural = post_format_get_plural_string( $term->slug );
 ...
 * @return string
 */
function post_format_get_plural_string( $slug ) {

  $strings = post_format_get_plural_strings();
 ...
 * @return array
 */
function post_format_get_plural_strings() {
  ...
  //  'standard' => __( 'Articles',       'my-textdomain' ), // Would this ever be used?
    ...
    'link'     => __( 'Decks',          'my-textdomain' ), // Different terminology for thulme.com
    'quote'    => __( 'Quotes',         'my-textdomain' ), // Use "Quotations"?
    'status'   => __( 'Status Updates', 'my-textdomain' ),
    'video'    => __( 'Videos',         'my-textdomain' ),
  );

  return apply_filters( 'post_format_plural_strings', $strings );
}